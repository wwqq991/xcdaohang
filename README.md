...
> 基于 [MeNav](https://github.com/rbetree/menav)，但书签是我一个个加上去的，不是机器导入糊弄人的。（好吧，其实是把链接直接丢给Claude了）
...
**VPS 和云服务**——我平时喜欢折腾便宜的 VPS，踩过不少坑也捡过不少漏。里面的链接都是真实使用过的（除了dmit，因为我没抢到）

**AI API 中转站**——OpenRouter、SiliconFlow、Right Codes……我试过的 AI 聚合/中转平台都放这儿了，有便宜的、有稳定的、有送免费额度的，看需求选。（如果愿意用我的邀请链接就更好了）

**自建小服务**——邮箱、音乐、PDF 工具、在线白板、文件快递柜、DOS 怀旧游戏……都是自己搭在廉价 VPS 上的，不过一部分已经关掉了，因为实在是没太大用

**省钱相关**——免费域名、低价 VPS、拼车代充、eSIM 流量卡，白嫖的结果不重要，主要是白嫖的过程有意思
